...
void CGameInstance::Set_Transform(CPipeLine::TRANSFORMSTATE eTransformState, _matrix TransformMatrix)
{
	if (nullptr == m_pPipeLine)
		return;
	
	return m_pPipeLine->Set_Transform(eTransformState, TransformMatrix);
}

_matrix CGameInstance::Get_TransformMatrix(CPipeLine::TRANSFORMSTATE eTransformState)
{
	if (nullptr == m_pPipeLine)
...
_float4x4 CGameInstance::Get_TransformFloat4x4(CPipeLine::TRANSFORMSTATE eTransformState)
{
	if (nullptr == m_pPipeLine)
		return _float4x4();
...
_float4x4 CGameInstance::Get_TransformFloat4x4_TP(CPipeLine::TRANSFORMSTATE eTransformState)
{
	if (nullptr == m_pPipeLine)
		return _float4x4();
