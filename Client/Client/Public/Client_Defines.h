...
namespace Client
{
	...
	enum SHADERUI_EFFECT { SHADER_SLASH, SHADER_ROLLCUT , SHADERM_TWOCOLOR_PRIORITY, SHADERM_TWOCOLOR_DEFAULT, SHADERM_ONLY_TEXTURE,
		SHADERM_TWOCOLOR_NOTALPHASET };

	enum SHADERUI_EFFECT_TEX { SHADER_SMOKE, SHADER_HITFLASH_TEX, SHADER_HITFLASH_TEX2, SHADER_HITFLASH_TEX3, SHADER_TWOCOLOR_NOT_ALPHASET , 
