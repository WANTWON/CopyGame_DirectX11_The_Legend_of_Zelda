...
namespace Client
{
	...
	enum SHADERUI_EFFECT { SHADER_SLASH, SHADER_ROLLCUT , SHADER_HITFLASH, SHADER_HITRING, SHADER_HITSPARK, SHADER_GRASS, SHADER_DEADSMOKE };
	enum SHADERUI_EFFECT_TEX { SHADER_SMOKE, SHADER_HITFLASH_TEX, SHADER_HITFLASH_TEX2, SHADER_HITFLASH_TEX3, SHADER_GRASS_TEX , 
		SHADER_DEADGLOW, SHADER_DEADGLOW_PINK, SHADER_SMOKEBACK, SHADER_SMOKEFRONT };
