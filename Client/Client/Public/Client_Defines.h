...
namespace Client
{
	...
	enum SHADERUI_EFFECT_TEX { SHADER_ONECOLOR, SHADER_HITFLASH_TEX, SHADER_HITFLASH_TEX2, SHADER_HITFLASH_TEX3, SHADER_TWOCOLOR_NOT_ALPHASET , 
		 SHADER_TWOCOLOR_PRIORITY, SHADER_TWOCOLOR_DEFAULT, SHADER_SMOKEBACK, SHADER_SMOKEFRONT, SHADER_ONLY_TEXTURE};
