...
{
public:
	enum ITEM_STATE { ITEM_EQUIP, ITEM_USABLE, ITEM_COLLECT, ITEM_DGNKEY , ITEM_QUEST };
	...
	enum COLLECT_TEXLIST {COLLECT_NONE, COLLECT_DRUM, COLLECT_VIOLIN, COLLECT_TRUMPET, COLLECT_BELL, COLLECT_HARP, 
		COLLECT_XYLOPHONE, COLLECT_TRIANGLE, COLLECT_PIANO };
	enum DGNKEY_TEXLIST { DGN_NONE, DGN_LEVEL1, DGN_LEVEL2, DGN_LEVEL3 , DGN_LEVEL4, DGN_LEVEL5 };
	enum QUEST_TEXLIST {QUEST_NONE};
